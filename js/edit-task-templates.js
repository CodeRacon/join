...
function editTaskHTML(task) {
	return /*html*/ `<div class="overlay-wrapper">
	<form
		onsubmit="validateEditTaskForm(event); 
		return false;"
		novalidate>
		<div class="single-task-card">
			...
			<div class="title-cont">
				...
				<input
					...
					required />
					<p class="error-message" id="title-error-edit">				
				</p>
			</div>
			...
			<div class="date-cont">
				...
				/>
				<p class="error-message" id="date-error-edit">				
				</p>
			</div>
		...
		<div class="ok-btn-cont btn-span-img-ctn">
			<button
				class="btn-borders btn-create"
				type="submit"
				onsubmit="validateEditTaskForm()">
				OK
				<img src="./assets/img/icons/add-task/check.svg" alt="check" />
			</button>
		</div>
	</form>
</div>`;
